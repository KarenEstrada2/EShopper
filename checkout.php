			...
			<div class="table-responsive cart_info">
				<table class="table table-condensed">
					...
					<tbody>
						<?php 
						$total=0; 
					if(file_exists('carritocompras.txt')){ $content = trim(file_get_contents('carritocompras.txt '), PHP_EOL);
					$lineas = explode (PHP_EOL, $content);
					foreach($lineas as $linea) { List($productoE, $precioE) = explode(',', $linea);
						?>
						<tr>
